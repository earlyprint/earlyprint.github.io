...
$( document ).ready(function() {
    ...
    if (GLOBAL_URL_PARAMS.has('which_to_do')) {
        ...
        $.get(HOSTNAME + '/poetry_disco/run_query.php?' + GLOBAL_URL_PARAMS.toLocaleString())
            .done(
                function(data) {
...
function handle_button(n) {
    ...
    window.location.assign('/lab/tool_poetry_disco.html?' + GLOBAL_URL_PARAMS.toLocaleString());
}
