...
var EEBO_URL_PREFIX = 'https://earlyprint.wustl.edu/proxy_ngrams.php?url=https://earlyprint.wustl.edu/eebospellingbrowserv3/';
...
function linkToGrok(word, corpus) {
    ...
    window.open('https://eplab.artsci.wustl.edu/blacklab-frontend-4.0.1-SNAPSHOT/earlyprint/search/hits?number=20&first=0&patt=%5B' + 
