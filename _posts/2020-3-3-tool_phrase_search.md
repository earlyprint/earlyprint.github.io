...
<script type="module">
  ...
  const getFormQuery = (string) => {
    ...
    let request = new Request(`http://ada.artsci.wustl.edu:8080/blacklab-server-1.7.3/eebotcp/hits?number=20&patt=${encodeURIComponent(pattern)}&outputformat=json`);
