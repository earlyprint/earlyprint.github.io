...
<div class="flex items-center justify-center pa3 bg-lightest-blue navy">
  <svg class="w1" data-icon="info" viewBox="0 0 32 32" style="fill:currentcolor">
    <title>info icon</title>
    <path d="M16 0 A16 16 0 0 1 16 32 A16 16 0 0 1 16 0 M19 15 L13 15 L13 26 L19 26 z M16 6 A3 3 0 0 0 16 12 A3 3 0 0 0 16 6"></path>
  </svg>
  <span class="lh-title ml3">This legacy version of the Ngram Browser is no longer being updated. For more accurate results and better searching options, try the <a href="/ngram/" class="b" style="color:inherit;text-decoration:underline;background-color:inherit;">new and improved Ngram Browser</a>!</span>
</div>
